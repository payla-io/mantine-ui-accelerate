import { ActionIcon, Box, Popover, TextInput, TextInputProps } from "@mantine/core";
...
export default function CDateInputPicker(props: Readonly<CDateInputPickerProps>) {
  ...
  return <Box>
    <TextInput component={InputMask} rightSection={
      getDateInstance ? <Popover width={200} position="bottom" withArrow shadow="md">
      <Popover.Target>
      <ActionIcon variant="subtle"><IconCalendar /></ActionIcon>
      </Popover.Target>
      ...
      <DatePicker {...pickerProps} 
        ...
        if (props.form && props.name) {
          props.form.setFieldValue(props.name, formatDate ? formatDate(v?.toString() as string): v?.toString() as string);
        }
      }} />
      </Popover.Dropdown>
    </Popover> : undefined
