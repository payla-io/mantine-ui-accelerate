...
export interface CDropzoneProps {
...
export const CDropzone = React.forwardRef<RefType, CDropzoneProps>(
  (props, ref) => {
    return (
        ...
        <MantineDropzone
          ...
          onDrop={async (files) => {
            props.form.setFieldValue(
              props.name,
              !props.noBase64 ? await fileToBase64(files[0]) : files[0]
            );
          }}
          onReject={(files) => {
                  ...
                  <Flex gap="xs">
                    <Box>
                      <MantineDropzone.Reject>
                        <IconX size="32px" stroke={1.5} color="red" />
                      </MantineDropzone.Reject>
